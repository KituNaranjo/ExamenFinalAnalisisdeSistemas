...
<main>
    ...
    <form method="post" action="cambioClave.jsp" onsubmit="return confirmarCambioClave()">
        <table>
            ...
            <tr>
                <td></td>
                <td><input type="submit" value="Cambiar contraseña" class="boton-enlace"></td>
            </tr>
        </table>
    </form>
    <%    
    ...
    <script>
        ...
        window.location.href = "login.jsp"; // Redirigir a login.jsp después del cambio exitoso
    </script>
    <%
        } else {
    %>
    <script>
        alert("No se pudo cambiar la contraseña. Por favor, inténtalo nuevamente.");
    </script>
    <%
        }
    }
