    ...
    <table border="1">
        ...
        <c:forEach items="${productos}" var="producto">
            <tr>
                ...
                <td><a href="AgregarAlCarrito.jsp?id=${producto.id}&nombre=${producto.nombre}&precio=${producto.precio}" class="boton-enlace">Agregar al carrito</a></td>
            </tr>
        </c:forEach>
    </table>
    <a href="carrito.jsp" class="boton-enlace">Ver carrito de compras</a><br>
	<br>
	<footer>
