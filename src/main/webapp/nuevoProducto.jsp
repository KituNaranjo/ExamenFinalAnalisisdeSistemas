...
<main>
	...
	<table>
		<tr>
			<td>Id Producto</td>
			<td><input type="text" name="id" required="required" style="width: 200px; height: 12px; border-radius: 20px; padding: 10px; font-size: 16px;"></td>
		</tr>
		<tr>
			<td>Categoría</td>
			<td><% 
		...
		<tr>
			<td>Nombre</td>
			<td><input type="text" name="nombre" required="required" style="width: 200px; height: 12px; border-radius: 20px; padding: 10px; font-size: 16px;"></td>
		</tr>
		<tr>
			<td>Cantidad</td>
			<td><input type="text" name="cantidad" required="required" style="width: 200px; height: 12px; border-radius: 20px; padding: 10px; font-size: 16px;"></td>
		</tr>
		<tr>
			<td>Precio</td>
			<td><input type="text" name="precio" required ="required" style="width: 200px; height: 12px; border-radius: 20px; padding: 10px; font-size: 16px;"></td>
		</tr>
		<tr>
		...
		<tr>
			<td><input type="submit" class="boton-enlace"/></td>
			<td><input type="reset" class="boton-enlace"/></td>
		</tr>
	</table>
	</form>	    
  	</div>
